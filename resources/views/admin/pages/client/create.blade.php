...
<div class="bg-white p-20 col-12 m-t-30">
    <form action="{{route('admin.setting.client.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <fieldset>
            <legend class="m-b-15">Add Client</legend>
            <div class="form-group">
                <label for="image">Image</label> <br>
                <img id="user-image" style="width: 300px; height: 300px;" src="{{asset('images/300x300.png')}}"
