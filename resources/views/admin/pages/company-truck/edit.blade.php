...
@section('content')
<a href="{{route('admin.user.company.truck.index', $company->id)}}" class="btn btn-white"> &lt; Back</a>
<div class="bg-white p-20 col-12 m-t-30">
    <form action="{{route('admin.user.company.truck.update', ["company" => $company->id, "truck" => $truck->id])}}"
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <select name="truck_category_id" id="truck_category_id" class="form-control">
                    ...
                    <option value="{{$item->id}}" {{selected($item->id, $truck->truckCategory->id)}}>
